...
var NoticeIcon = function (props) {
        ...
        React.Children.forEach(children, function (child) {
            ...
            panes.push(React.createElement(TabPane, { tab: tabTitle, key: tabKey },
                React.createElement(NoticeList, __assign({ clearText: clearText, viewMoreText: viewMoreText, data: list, onClear: function () { return onClear && onClear(title, tabKey); }, onClick: function (item) {
                    ...
                    }, showClear: showClear, showViewMore: showViewMore }, child.props))));
        });
    ...
    var /*className,*/ count = props.count, bell = props.bell;
    ...
    var NoticeBellIcon = bell || React.createElement(BellOutlined /*className={styles.icon}*/, null);
    var trigger = (React.createElement("span", null,
        React.createElement(Badge, { count: count, style: { boxShadow: "none" } }, NoticeBellIcon)));
    if (!notificationBox) {
        return trigger;
    }
    return (React.createElement(HeaderDropdown, { placement: "bottomRight", overlay: notificationBox, 
        // overlayClassName={styles.popover}
        trigger: ["click"], visible: visible, onVisibleChange: setVisible }, trigger));
};
