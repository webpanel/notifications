...
var NotificationsSeen = /** @class */ (function (_super) {
    ...
    function NotificationsSeen() {
        ...
        _this.runMutationIfNeeded = function (mutation) {
            ...
            mutation({ channel: channel, reference: reference });
        };
        return _this;
    }
    NotificationsSeen.prototype.render = function () {
        ...
        return (React.createElement(Mutation, { mutation: SEEN_NOTIFICATION, variables: { channel: channel, reference: reference, referenceID: referenceID, date: date, principal: principal } }, function (mutation) {
