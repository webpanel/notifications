...
var NotificationsMenu = /** @class */ (function (_super) {
    ...
    NotificationsMenu.prototype.render = function () {
        ...
        return (React.createElement(NoticeIcon, { count: (data && data.filter(function (x) { return !x.seen; }).length) || 0, loading: loading, onClear: this.onClear, onItemClick: this.onItemClick(collection, reload) }, _tabs.map(function (tab, i) {
