    ...
    NotificationsMenu.prototype.render = function () {
        ...
        return (React.createElement(Query, { query: QUERY_NOTIFICATIONS, pollInterval: 10000, variables: { principal: this.props.principal }, children: function (_a) {
                ...
                return (React.createElement(NoticeIcon, { count: data.notifications &&
                        data.notifications.filter(function (x) { return !x.seen; }).length, loading: loading, onClear: _this.onClear, onItemClick: _this.onItemClick(history) }, tabs.map(function (t) { return (React.createElement(NoticeIcon.Tab, { list: _this.notificationsForTab(data.notifications || [], t), title: t.title, showClear: false })); })));
            } }));
    };
